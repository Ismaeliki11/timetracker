...
const translations = {
  en: {
    ...
    'landing_hero_subtitle': 'The free tool to keep an accurate record of your hours — by project, client, or activity. Built for freelancers, students, and anyone who values their time.',
    ...
    'landing_features_subtitle': 'A focused set of tools to keep you on track without getting in your way.',
    ...
    'landing_feat4_desc': 'No account needed to start. Sign in to sync your data automatically across all your devices.',
    ...
    'landing_free_subtitle': 'Time Tracker is completely free. Sign up in seconds and start tracking today.',
  ...
  es: {
    ...
    'landing_hero_subtitle': 'La herramienta gratuita para llevar un registro exacto de tus horas — por proyecto, cliente o actividad. Diseñada para freelancers, estudiantes y cualquiera que valore su tiempo.',
    ...
    'landing_features_subtitle': 'Un conjunto de herramientas diseñadas para que lleves el control sin complicaciones.',
    ...
    'landing_feat4_desc': 'No necesitas cuenta para empezar. Inicia sesión para sincronizar tus datos en todos tus dispositivos.',
    ...
    'landing_free_subtitle': 'Time Tracker es completamente gratuito. Regístrate en segundos y empieza a registrar hoy.',
